...
provides our novel parallel methods on GPU for reverse conversion on protein chain.  
	...
	- ItoC.h:  This the header file for Internal to Cartesian coordinate, and helps write the output of 
			   internal to Cartesian conversion into pdb similar format.
               you can Include this header to InternaltoCartesian Source code.
